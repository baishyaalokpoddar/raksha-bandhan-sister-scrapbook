      ...
      <div className="bg-white rounded-3xl p-5 sm:p-7 shadow-sm border border-stone-200 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
          <a
            ...
            className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold shadow-md flex items-center gap-1.5 transition-all transform active:scale-95"
            title="Open and preview the live greeting experience in a new tab"
          >
            <ExternalLink className="w-3.5 h-3.5 text-emerald-200" />
            <span>Live Review URL ↗</span>
          </a>
      ...
      <div className="bg-gradient-to-r from-red-50 via-amber-50 to-rose-50 rounded-2xl p-4 border-2 border-red-200 mb-6 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <div className="text-xs font-bold text-stone-900 flex items-center gap-1.5">
              ...
              <span className="text-[10px] bg-emerald-100 text-emerald-800 font-bold px-1.5 py-0.2 rounded">Live Active</span>
            </div>
            <a
              href={displayShareUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-red-700 hover:text-red-900 font-mono break-all underline decoration-red-300 hover:decoration-red-600 transition-colors flex items-center gap-1 mt-0.5"
              suppressHydrationWarning
              title="Click to open live greeting in new tab"
            >
              <span className="truncate">{displayShareUrl}</span>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto justify-end">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-3.5 py-2 bg-white hover:bg-stone-50 text-emerald-700 hover:text-emerald-800 text-xs font-bold rounded-lg border border-emerald-300 shadow-2xs flex items-center gap-1.5 transition-colors"
          >
            <ExternalLink className="w-3.5 h-3.5" />
            <span>Open Live Review</span>
          </a>
